...
const Skills = () => {
  ...
  font-bold text-8xl mt-64 w-full text-center md:text-6xl md:mt-32"
      ...
      >
        ...
        <Skill name="Github" x="-37vw" y="-5vw" />
        <Skill name="NodeJS" x="20vw" y="-14vw" />
        <Skill name="MongoDB" x="32vw" y="-2vw" />
        <Skill name="SocketIO" x="-25vw" y="15vw" />
        <Skill name="TailwindCSS" x="22vw" y="18vw" />
      </div>
    </>
  );
};
