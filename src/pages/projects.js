...
import project1 from "../../public/images/projects/avatar-art.png";
import project2 from "../../public/images/projects/blog.png";
...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article
      className="w-full flex flex-col items-center justify-between rounded-3xl relative 
    ...
    >
      ...
      <div className="w-full flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        <span className="text-primary font-medium text-xl mt-[12px] dark:text-primaryDark xs:text-base">
          {type}
        </span>
        <Link
          href={link}
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-12">
              <FeaturedProject
                title="Food Blog (2023)"
                img={project2}
                summary="A Food Blog Web using Next 13, Tailwindcss. "
                link="https://food-blog-next13.vercel.app/"
                github="/"
                type="Featured Project"
              />
            </div>
